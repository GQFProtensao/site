    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      >
        <div class="sm:col-span-12 lg:col-span-3">
          <div class="mb-2">
            <NuxtLink to="/" class="inline-block" aria-label="Cruip">
              <svg
                class="w-8 h-8"
                viewBox="0 0 32 32"
      ...
      >
        ...
        <div class="text-sm text-gray-600 mr-4">
          Desenvolvido por
          <a class="text-blue-600 hover:underline" href="https://cruip.com/"
            >BDS Software</a
