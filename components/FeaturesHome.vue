    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-12 md:pt-20">
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16">
          <h1 class="h2 mb-4">Explore nossas soluções</h1>
        ...
        <div class="md:grid md:grid-cols-12 md:gap-6">
          ...
          >
            <div class="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
              <h3 class="h3 mb-3">Uma podera solução</h3>
              <p class="text-xl text-gray-600">
            ...
            <div class="mb-8 md:mb-0">
              <a
                ...
                :class="{
                  ['bg-white shadow-md border-gray-200 hover:shadow-lg']:
                    tab !== 1,
                  ['bg-gray-200 border-transparent']: tab === 1,
                }"
                href="#0"
              >
                <div>
              ...
              <a
                ...
                :class="{
                  ['bg-white shadow-md border-gray-200 hover:shadow-lg']:
                    tab !== 2,
                  ['bg-gray-200 border-transparent']: tab === 2,
                }"
                href="#0"
              >
                <div>
              ...
              <a
                ...
                :class="{
                  ['bg-white shadow-md border-gray-200 hover:shadow-lg']:
                    tab !== 3,
                  ['bg-gray-200 border-transparent']: tab === 3,
                }"
                href="#0"
              >
                <div>
          ...
          >
            <div class="relative flex flex-col text-center lg:text-right">
              ...
              >
                <div v-show="tab === 1" class="relative inline-flex flex-col">
                  <img
                  ...
                  />
                  <img
                    class="md:max-w-none absolute w-full left-0 top-1/3 transform animate-float"
                    src="@/assets/features-element.png"
                    width="500"
                    height="44"
                    alt="Element"
                  />
              ...
              <Transition
                ...
                leaveEnd="opacity-0 -translate-y-16"
              >
                <div v-show="tab === 2" class="relative inline-flex flex-col">
                  <img
                    class="md:max-w-none mx-auto rounded"
                    src="@/assets/features-bg.png"
                    width="500"
              ...
              <Transition
                ...
                leaveEnd="opacity-0 -translate-y-16"
              >
                <div v-show="tab === 3" class="relative inline-flex flex-col">
                  <img
                    class="md:max-w-none mx-auto rounded"
                    src="@/assets/features-bg.png"
                    width="500"
